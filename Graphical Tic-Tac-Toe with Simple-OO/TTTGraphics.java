...
public class TTTGraphics extends JFrame {
   ...
   public static final int CELL_SIZE = 240; // cell width/height (square)
   public static final int BOARD_WIDTH  = CELL_SIZE * COLS; // the drawing canvas
   public static final int BOARD_HEIGHT = CELL_SIZE * ROWS;
   public static final int GRID_WIDTH = 24;                  // Grid-line's width
   public static final int GRID_WIDHT_HALF = GRID_WIDTH / 2;
   // Symbols (cross/nought) are displayed inside a cell, with padding from border
   public static final int CELL_PADDING = CELL_SIZE / 5;
   public static final int SYMBOL_SIZE = CELL_SIZE - CELL_PADDING * 2; // width/height
   public static final int SYMBOL_STROKE_WIDTH = 16; // pen's stroke width
   public static final Color COLOR_BG = Color.PINK;  // background
   public static final Color COLOR_BG_STATUS = new Color(216, 216, 216);
   public static final Color COLOR_GRID   = Color.BLACK;  // grid lines
   public static final Color COLOR_CROSS  = Color.GREEN;  // Red #D32D41
   public static final Color COLOR_NOUGHT = Color.CYAN; // Blue #4CB5F5
